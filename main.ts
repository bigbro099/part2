...
info.onLifeZero(function () {
    music.stopAllSounds()
    game.gameOver(false)
    music.play(music.stringPlayable("A F E D C E C E ", 120), music.PlaybackMode.UntilDone)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    sprites.destroy(otherSprite)
    info.changeScoreBy(1)
})
let bad_guy_thing: Sprite = null
let mySprite2: Sprite = null
let sir_kudugon: Sprite = null
MakeyMakey.setMakeyMakeyDefaults()
music.play(music.stringPlayable("C5 A G F A G G C5 ", 120), music.PlaybackMode.LoopingInBackground)
scene.setBackgroundImage(img`
    ...
    7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
    `)
sir_kudugon = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f f 2 2 f f f . . . . 
    . . . f f f 2 2 2 2 f f f . . . 
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(sir_kudugon, 100, 0)
sir_kudugon.setPosition(80, 106)
sir_kudugon.setStayInScreen(true)
info.startCountdown(30)
game.setGameOverScoringType(game.ScoringType.HighScore)
info.setLife(3)
game.setGameOverMessage(false, "lol u died lol lol u died")
...
game.onUpdateInterval(1000, function () {
    ...
    mySprite2.setVelocity(0, randint(40, 150))
})
game.onUpdateInterval(1500, function () {
    bad_guy_thing = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . f . . . . . . . . . 
        . . . . . f f f . . . . . . . . 
    ...
    bad_guy_thing.setPosition(randint(0, 150), 0)
    bad_guy_thing.setVelocity(0, randint(40, 80))
})
